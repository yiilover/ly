...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name2, goods_link, goods_name_style, goods_sn, " .
                ...
                "VALUES ('$_POST[goods_name]', '$_POST[goods_name2]','$_POST[goods_link]','$goods_name_style', '$goods_sn', '$catgory_id', " .
