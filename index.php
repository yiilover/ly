...
//require(dirname(__FILE__) . '/includes/lib_article.php');
if ((DEBUG_MODE & 2) != 2)
{
    $smarty->caching = true;
}
...
//    print_r(get_recommend_goods('best'));die;
...
//    $smarty->assign('shop_notice',     $_CFG['shop_notice']);       // 商店公告
 $smarty->assign('article_notice',     get_cat_articles(4,1,7));       // 最新公告
 $smarty->assign('article_circle',     get_cat_articles(5,1,7));       // 行业动态
// print_r(get_cat_articles(6,1,7));die;
 $smarty->assign('article_webshop',     get_cat_articles(6,1,7));       // 网店推广
 $smarty->assign('article_setup',     get_cat_articles(7,1,7));       // 网络创业
$str_url = str_replace('/','',$_SERVER['REQUEST_URI']);
//var_dump($str_url);die;
$smarty->assign('str_url',$str_url)  ;

//print_r(get_cat_articles());die;
