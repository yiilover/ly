...
//通信相关
define('UC_KEY', 'fdF3RcIeJbw825BcSbhcg5y2s8M1c9EeCfydX7D4r9iblcl20ahfAdj1W2L4WbK5');				// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://ucenter.ddecshop.com');	// UCenter 的 URL 地址, 在调用头像时依赖此常量
